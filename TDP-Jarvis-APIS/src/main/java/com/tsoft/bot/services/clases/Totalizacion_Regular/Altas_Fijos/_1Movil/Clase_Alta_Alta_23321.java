...
public class Clase_Alta_Alta_23321 {
    ...
    public static String showData(String status) throws Throwable {
        ...
        ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 3, 2, resultado);
        ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 3, 3, "1. Alta + (Alta)");
        ...
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 3, 13, "PASS");
        }
        else
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 3, 13, "FAILED");
        }

        for (int i = 0; i < escenario1.length; i++)
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 3, i + 4, "" + escenario1[i] + ": " + resultado.contains(escenario1[i]) + i);
        }
