...
public class Clase_Alta_Alta_23329 {
    ...
    public static String showData(String status) throws Throwable {
        ...
        ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 4, 2, resultado);
        ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 4, 3, "1. Alta + (Alta)");
        ...
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 4, 13, "PASS");
        }
        else
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 4, 13, "FAILED");
        }

        for (int i = 0; i < escenario1.length; i++)
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 4, i + 4, "" + escenario1[i] + ": " + resultado.contains(escenario1[i]) + i);
        }
