...
public class Clase_Replace_Alta_23322 {
    ...
    public static String showData(String status) throws Throwable {
        ...
        ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 6, 2, resultado);
        ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 6, 3, "10. Replace + (Alta)");
        ...
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 6, 13, "PASS");
        }
        else
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 6, 13, "FAILED");
        }

        for (int i = 0; i < escenario1.length; i++)
        {
            ExcelReader.writeCellValue(EXCEL_WEB, HOJA, 6, i + 4, "" + escenario1[i] + ": " + resultado.contains(escenario1[i]) + i);
        }
